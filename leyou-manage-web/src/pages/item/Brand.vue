    ...
    >
      <template slot="items" slot-scope="props">
        ...
        <td class="justify-center layout px-0">
          <v-btn icon @click="editBrand(props.item,props.oldBrand)">
...
<script>
  ...
  export default {
    ...
    methods: {
      addBrand() {
        this.brand = {};   // 将brand数据模型数据清空
        this.isEdit = false;  // 将弹出框的名字设置为<新增品牌>
        this.show = true;   // 显示窗口
      },
    editBrand(item,oldBrand) {
        // 根据品牌信息查询商品分类
        ...
        //     this.oldBrand = resp.data;
        //   })

      },
      mounted(){
          console.log(this.oldBrand,'oldBrandoldBrandoldBrandoldBrand')
       },
      deleteBrand(item) {
      ...
      getDataFromApi(){
        ...
        this.$http.get("/item/brand/page",{
          ...
          this.loading = false; //完成赋值以后，把加载状态更改为false，不在加载数据
        })
